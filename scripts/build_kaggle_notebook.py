"""
Script tự động sinh file Jupyter Notebook (GRACE_Kaggle_Reproduce.ipynb)
được chuẩn hóa tuyệt đối cho việc chạy thực nghiệm (Stage 5) tại môi trường GPU Kaggle / Google Colab.
"""
...
output_path = Path(__file__).parent.resolve() / "GRACE_Kaggle_Reproduce.ipynb"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(notebook_content, f, ensure_ascii=False, indent=2)

print(f"[OK] THÀNH CÔNG! Đã xuất xưởng sổ tay Jupyter Notebook cho Kaggle tại: {output_path}")
