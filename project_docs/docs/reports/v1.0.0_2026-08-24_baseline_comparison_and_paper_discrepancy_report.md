...
target_component: "GRACE Baseline Benchmark Runs (Ver08, Ver11, Ver12, Ver13) & Paper vs Codebase Discrepancy Analysis"
tags: ["report", "baseline", "devign", "reveal", "ver08", "ver11", "ver12", "ver13", "paper-vs-code", "figure-6", "ai-friendly"]
summary: "Báo cáo toàn diện đối chiếu 4 phiên bản thực nghiệm Baseline (Ver08, Ver11, Ver12, Ver13) trên 100% test set của Devign và Reveal, đồng thời phân tích chi tiết các điểm sai lệch kỹ thuật giữa mã nguồn tác giả cung cấp và bài báo khoa học GRACE công bố."
---
